...
function bct:trigger/using/mainhand/event/main
...
function #pde:data.rw {player:"this"}
    ...
    execute unless score @s bct.fsm.using matches 3 unless score @s bct.fsm.using matches 0 run function bct:trigger/using/mainhand/_
